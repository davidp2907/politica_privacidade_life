        ...
        <div className="bg-white shadow-sm rounded-lg p-6 sm:p-8 animate-fadeIn">
          ...
          <div className="prose prose-blue max-w-none">
            <p className="text-gray-700">
              Esta Política de Privacidade se aplica ao aplicativo Lifenergy para dispositivos móveis, criado por Wedja Psicologia.

              O aplicativo é disponibilizado como um serviço [de código aberto / gratuito / freemium / suportado por anúncios / comercial]. Esta definição pode ser ajustada conforme o modelo de negócio adotado pela empresa.

              Este serviço é fornecido “NO ESTADO EM QUE SE ENCONTRA”, ou seja, sem garantias explícitas ou implícitas quanto à sua disponibilidade, funcionamento ou adequação a propósitos específicos.

              Ao utilizar o aplicativo, você concorda com a coleta e o uso de informações conforme descrito nesta Política de Privacidade.
            </p>
            ...
            <ul className="list-disc pl-5 mb-4 text-gray-700">
              <li>Coletamos informações que você nos fornece voluntariamente, como nome, e-mail, e preferências de uso. Também coletamos automaticamente informações como:

                - Endereço IP (Protocolo de Internet) do seu dispositivo
                - Dados de acesso e navegação
                - Informações de localização geográfica aproximada

                Esses dados ajudam a garantir a segurança, melhorar nossos serviços e personalizar sua experiência no aplicativo.
              </li>
            ...
            <p className="text-gray-700 mt-4">
              ...
              que você nos forneça certas informações de identificação pessoal. As informações
